<template>
  <div class="annotation-editor">
    ...
    <div class="annotation-actions">
      <button class="btn-tiny-light" @click="save" :disabled="!draftSeverity && !draftNote.trim()">Save</button>
...
.annotation-head h4 { margin: 0; font: var(--text-small); color: var(--ink); }
...
.severity-chip.sev-query.active { background: var(--accent-soft); border-color: var(--accent); color: var(--accent); }
